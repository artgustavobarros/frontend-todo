   ...
   <Layout>
     <section className="w-[50rem] h-[30rem] bg-white flex rounded-3xl">
        ...
        <div className="flex flex-col gap-8 p-8 ml-20 items-end">
          ...
          <form className="flex flex-col gap-4" id="sign-up" onSubmit={handleSubmit(handleSignUpSubmit)}>
          ...
          <button type="submit" form="sign-up">// cadastrar</button>
          <Link to={'/sign-in'} className="text-text-pattern">// voltar</Link>
        </div>
      </section>
   </Layout>
  )
